...
class login_window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="C:\\Users\\Ajinkya\\Desktop\\face_recognition system\\college_image\\zxc.jpg")
        ...
        img1=Image.open(r"C:\Users\Ajinkya\Desktop\face_recognition system\college_image\mmp.png")
        ...
        img2=Image.open(r"C:\Users\Ajinkya\Desktop\face_recognition system\college_image\ty.jpg")
        img2=img2.resize((25,25),Image.ANTIALIAS)
        self.photoimage2=ImageTk.PhotoImage(img2)
        lblimg1=Label(image=self.photoimage2,bg="black",borderwidth=0)
        lblimg1.place(x=650,y=333,width=25,height=25)

        img3=Image.open(r"C:\Users\Ajinkya\Desktop\face_recognition system\college_image\lck.jpg")
    ...
    def login(self):
        ...
        elif self.txtuser.get()=="ajinkya612001" and self.txtpass.get()=="Aju1234":
...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="C:\\Users\\Ajinkya\\Desktop\\face_recognition system\\college_image\\jp.jpg")
        lbl_bg=Label(self.root,image=self.bg)
        lbl_bg.place(x=0,y=0,relwidth=1,relheight=1)

        self.bg1=ImageTk.PhotoImage(file="C:\\Users\\Ajinkya\\Desktop\\face_recognition system\\college_image\\asdf.jpg")
        ...
        img=Image.open(r"C:\Users\Ajinkya\Desktop\face_recognition system\college_image\register.jpg")
        img=img.resize((200,50),Image.ANTIALIAS)
        self.photoimage=ImageTk.PhotoImage(img)
        b1=Button(frame,image=self.photoimage,command=self.register_data,borderwidth=0,cursor="hand2")
        b1.place(x=10,y=440,width=200)

        img1=Image.open(r"C:\Users\Ajinkya\Desktop\face_recognition system\college_image\login.jpg")
