...
class Student:
    def __init__(self,root):
        ...
        #first img
        img=Image.open("C:\\Users\\LENOVO\Desktop\\face_recognition system\\college_image\\zp.jpg")
        ...
        #second img
        img1=Image.open("C:\\Users\\LENOVO\Desktop\\face_recognition system\\college_image\\rp.jpg")
        ...
        #third img
        img2=Image.open("C:\\Users\\LENOVO\Desktop\\face_recognition system\\college_image\\tp.jpg")
        ...
        img_left=Image.open("C:\\Users\\LENOVO\Desktop\\face_recognition system\\college_image\\gp.jpg")
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",font=("times new roman",13,"bold"),bg="blue",fg="white",width=80)
        ...
        img_right=Image.open("C:\\Users\\LENOVO\Desktop\\face_recognition system\\college_image\\tk.jpg")
...
#====================delete function==================
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                delete=messagebox.askyesno("Student Delete Page","Do you want to delete thid student",parent=self.root)
                if delete>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="Aj612001",database="face_recognizer")
                    my_cursor=conn.cursor()
